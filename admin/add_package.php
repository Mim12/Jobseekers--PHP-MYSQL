     ...
     <hr>
      <form action="add_package.php" method="POST">
        ...
        <div class="form-group">
         ...
         <button style="background-color: #138496 " name="submit" type="submit" class="btn btn-default"> Submit </button><br>
      </form>
...
// package store into database
   ...
   if(isset($_POST['submit'])){
      ...
      if(mysqli_query($connection,$package_sql)){
         header("Location: view_package.php?package_add_success= Package Successfully added." );
          exit;
      }else{
