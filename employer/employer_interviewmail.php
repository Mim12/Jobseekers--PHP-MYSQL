...
require '../database.php';
    ...
    if(isset($_GET['applyid']) && isset($_GET['id']) &&isset($_GET['link']) && isset($_GET['password']) && isset($_GET['time']) && isset($_GET['duration']) ){
        ...
        $mail->Username = 'universityproject456@gmail.com';      // your mail           
        $mail->Password = 'ejnqfcevcdvgxuyt';                    // mail less secure option password 
        $mail->SMTPSecure = 'tls';                            
        $mail->Port = 25;                                    

        $mail->setFrom('universityproject456@gmail.com', 'University Project');         // user your above mail
        ...
        if(!$mail->send()) {
            ...
            header( "Location: employer_interviewlist.php?interview_msg=Applicant has been called for interview" );
            exit();
        }
    }
    ?>