...
$post_data['success_url'] = "http://localhost/jobseekers/employer/payment_success.php?packageid=".$packageid."& employerid=".$employerid." & numberofpost=".$numberofpost." ";
$post_data['fail_url'] = "http://localhost/jobseekers/employer/payment_fail.php?employerid=".$employerid." ";
$post_data['cancel_url'] = "http://localhost/jobseekers/employer/payment_cancel.php?employerid=".$employerid." ";
