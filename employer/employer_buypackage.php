...
<br>
    ...
    <table class="w3-table-all">
      ...
      <tr>
        ...
        <td>
          <a class="btn btn-info" href="payment_checkout.php?packageprice= <?php echo $row['price']; ?>&packagename=<?php echo $row['name']; ?> &packageid=<?php echo $row['id']; ?>&numberofpost=<?php echo $row['numberofpost']; ?>">Buy</a>
        </td>
      </tr>
      <?php }
      ?>
