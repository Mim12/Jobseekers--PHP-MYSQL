...
if($code == 200 && !( curl_errno($handle)))
{
    ...
    $paymentsql="INSERT INTO payment (status,transid,cardtype,employerid,packageid,transtime) values ('$status','$tran_id','$card_type','$employerid','$packageid','$tran_date')";
    ...
    if(mysqli_num_rows($checksqlresult)>=1){
        ...
        {
            header("Location:http://localhost/jobseekers/employer/employer_buypackage.php?success_msg=Package successfully purchased & employerid=".$employerid."  ");
            exit();
