...
<!--End Nav Bar -->
    <br>
    <h3 style="text-align:center">Interviewing Tips</h3>
  <div class="view">
    <div class="vtitle"><h4>What Employers looking for:</h4></div>
    <div class="content">
    ...
    <div class="vtitle"><h4>Some Interview Tips Videos:</h4></div>
    <div class="tips">
