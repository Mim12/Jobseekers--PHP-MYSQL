...
<!-- end nav bar -->
    ...
    <div class="container">
        <div class="row">
          <div class="col-md-8 col-md-offset-3">
            ...
            <button Type="submit" name="userlogin" class ="btn btn-info">Submit</button>
            <br><br>
            <p>Doesn't have any account. <a href="user_signup.php" >Sign Up</a></p>
            </form>
  ...
  <?php
    ...
    elseif(isset($_GET['jobapplymsg'])){
      echo $_GET['jobapplymsg'];
    }
    ?>
